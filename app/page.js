...
const HeroBackground3D = dynamic(() => import('../components/HeroBackground3D'), {
    ssr: false,
    loading: () => <div className="absolute inset-0 z-0 bg-gradient-to-r from-purple-900 to-indigo-800"></div>
});
...
export default function Home() {
    ...
    return (
        <div className="bg-gray-900 text-gray-100 min-h-screen overflow-hidden">
            ...
            <div className="fixed bottom-4 right-1/2 z-30 bg-gray-900/70 rounded-full transform translate-x-1/2 px-4 py-3 lg:py-5 lg:px-2 ">
                ...
                <section className="relative min-h-screen flex items-center bg-gradient-to-r from-purple-900 to-indigo-800 text-white">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 w-full overflow-hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full" preserveAspectRatio="none">
                            <path fill="#111827" fillOpacity="1" d="M0,96L48,112C96,128,192,160,288,160C384,160,480,128,576,122.7C672,117,768,139,864,149.3C960,160,1056,160,1152,138.7C1248,117,1344,75,1392,53.3L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
                        </svg>
                    </div>
                </section>
                ...
                <section id="about" className="py-20 bg-gray-900">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <p className="text-lg text-gray-300 leading-relaxed mb-6">
                                On the backend side, I&apos;m proficient with Node.js, Express, NestJS, and have worked with various databases including MongoDB, MySQL, and PostgreSQL. I&apos;m also experienced with RESTful APIs, GraphQL, and AWS services such as S3, Cognito, Lambda, and Amplify.
                            </p>
                            <p className="text-lg text-gray-300 leading-relaxed mb-6">
                                Throughout my career, I&apos;ve utilized state management solutions like Redux, Context API, and Zustand, and have implemented responsive designs using Tailwind CSS, Material UI, and Bootstrap. I&apos;m passionate about creating clean, maintainable code and delivering high-quality applications that provide exceptional user experiences.
                            </p>
                            <p className="text-lg text-gray-300 leading-relaxed">
                                I&apos;m always eager to take on new challenges and collaborate with teams to build innovative solutions that solve real-world problems.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section id="experience" className="py-20 bg-gray-800">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                            ...
                            >
                                Senior Frontend Developer working on a comprehensive platform for the textile industry. Leading frontend development using Next.js, TypeScript, and Tailwind CSS. Implementing complex UI components, state management with Redux, and integrating with RESTful APIs.
                            </WorkCard>
                            <WorkCard
                                title="HEY Teknoloji"
                            ...
                            >
                                React Native Developer responsible for building and maintaining multiple mobile applications. Implemented complex UI components, integrated third-party services, and ensured cross-platform compatibility for iOS and Android.
                            </WorkCard>
                            <WorkCard
                                title="Simdatix"
                            ...
                            >
                                Frontend Developer for RoadJet, a tourism company in Germany. Developed their CMS and website using React, Next.js, and various frontend libraries. Worked in an Agile Scrum environment using Atlassian tools (JIRA, Confluence, Bitbucket).
                            </WorkCard>
                            <WorkCard
                                title="Bilinova"
                            ...
                            >
                                Full Stack Developer working on web and mobile applications using React, Next.js, and React Native. Implemented responsive designs, integrated APIs, and contributed to both frontend and backend development.
                            </WorkCard>
                            <WorkCard
                                title="Vizyon Design"
                                ...
                                address="Yozgat Teknopark / Turkey"
                            >
                                Web Developer creating PHP & Laravel applications with integrated 3D payment systems. Designed and implemented database schemas, user authentication, and secure payment processing.
                            </WorkCard>
                            <WorkCard
                            ...
                            >
                                Software Engineer developing automation systems for urban infrastructure imaging robots using Qt Framework and C++. Implemented serial port communication, video recording, panoramic image creation, and report generation for channel analysis.
                            </WorkCard>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
                            <SkillCardContainer title="Frontend Development">
                                ...
                                <SkillCard skill="next.js" percentage={95} />
                                ...
                                <SkillCard skill="html" percentage={95} />
                            </SkillCardContainer>
                    ...
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <ProjectCard
                                ...
                                tags={['React', 'NestJS', 'Government System', 'Secure Communication']}
                            ...
                            <ProjectCard
                                ...
                                tags={['AI', 'n8n', 'Backend Development', 'Frontend Development']}
                            ...
                            <ProjectCard
                                ...
                                tags={['React Native', 'Backend Development', 'E-commerce', 'Mobile App']}
                            ...
                            <ProjectCard
                                ...
                                tags={['React Native', 'Maintenance', 'Operations', 'Mobile App']}
                            ...
                            <ProjectCard
                                ...
                                tags={['AI', 'Market Analysis', 'Data Visualization', 'Mobile App']}
                ...
                <footer className="bg-gray-950 text-white py-12">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                            <p>&copy; {new Date().getFullYear()} Muhittin Darı. All rights reserved.</p>
                        </div>
                    </div>
                </footer>
            </main>
